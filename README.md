...
1. Use Supabase project `fnkkeadpkjshsnjmoznl` and run every SQL file in `supabase/migrations` in filename order. Existing installations must run `202607150001_inventory_reporting.sql`, `202607160001_document_snapshots_and_issuers.sql`, then `202607160002_document_methods.sql` before deploying this version.
