  ...
  return (
    <section className="dashboard-page">
      ...
      <div className="grid-4 dashboard-metrics">
        ...
        <DashboardMetric label="Total Gross Profit" value={currency.format(summary.grossProfit)} detail={`${summary.grossProfitPercentage.toFixed(1)}% gross profit`} icon={TrendingUp} />
      ...
      <div className="dashboard-second-row">
        <div className="card pad profit-guide">
          ...
          <div className="profit-breakdown"><span>Sales <b>{currency.format(summary.sales)}</b></span><span>Costing <b>{currency.format(summary.costing)}</b></span><span>Gross Profit <b>{currency.format(summary.grossProfit)}</b></span></div>
        </div>
